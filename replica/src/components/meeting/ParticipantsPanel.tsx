...
import { 
  ...
  MoreVertical, UserPlus, Crown, Shield
} from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
    ...
    <AnimatePresence>
      {isParticipantsOpen && (
        ...
        >
          ...
          {/* Host Controls */}
          {canControl && (
            <div className="p-4 border-b border-[#404040] space-y-2">
              <Button
                onClick={muteAll}
                variant="outline"
...
function ParticipantItem({
  ...
  return (
    <div className="flex items-center justify-between p-4 hover:bg-[#232323] transition-colors">
      ...
      <div className="flex items-center gap-2">
        ...
        {canControl && !isCurrentUser && (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="bg-[#232323] border-[#404040]">
