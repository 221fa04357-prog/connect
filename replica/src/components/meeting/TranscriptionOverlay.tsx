...
export function TranscriptionOverlay() {
    ...
    const { meeting, isAudioMuted, localStream } = useMeetingStore();
    ...
    // Diagnostic logging
    if (currentCaption.length > 0 && !shouldShow) {
        console.log('[TranscriptionOverlay] Caption blocked from showing:', {
            isTranscriptionEnabled,
            isCaptionsAllowed,
            hasCaption: currentCaption.length > 0
        });
    }
